...
API_TOKEN = '8029823954:AAHYYoBmCF28GZV3ZB_MR-bg24xOJCpAp_8'
ADMIN_ID = '7507566865'
MAX_RESTARTS = 5
...
async def main():
    ...
    while True:
        ...
        process = start_bot()
        await notify_admin("🚀 Your Codes Was Successful By @YouTuberGhostYT Bot is starting...")

        while process.poll() is None:
            await asyncio.sleep(5)
        
        logging.warning("Bot process terminated. Restarting in 10 seconds...")
        await notify_admin("⚠️ The bot has crashed Because Of Error Please Check In Your Codespace Terminal If It Is A Syntax Problem Contact Me :- @ZEUSxIG If It Is Not 🚫 Dont DM Just Chill.")
        restart_count += 1
